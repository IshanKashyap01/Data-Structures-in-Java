...
the profit earned is maximised. There are certain users who will subscribe to
...
where m is total number of subscribers whose budget is greater than or equal to
x.
...
Budget of subscribers (separated by space)
